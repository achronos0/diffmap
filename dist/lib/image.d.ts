 ...
 * @module
 */
import { AnyPixelColor, AnyRawPixels, FloatRawPixels, IntRawPixels, Point, RgbaPixelColor, YiqPixelColor } from './types.js';
/**
 ...
 */
export declare class RgbImage extends Image<IntRawPixels, RgbaPixelColor> {
    /**
     ...
     */
    static create(width: number, height: number): RgbImage;
    /**
 ...
 */
export declare class RgbaImage extends Image<IntRawPixels, RgbaPixelColor> {
    /**
     ...
     */
    static create(width: number, height: number): RgbaImage;
    /**
 ...
 */
export declare class YiqImage extends Image<FloatRawPixels, YiqPixelColor> {
    /**
     ...
     */
    static create(width: number, height: number): YiqImage;
    /**
 ...
 */
export type Intmap = Valuemap<IntRawPixels>;
/**
 * An in-memory single-channel image with floating-point values for each pixel
 */
export type Floatmap = Valuemap<FloatRawPixels>;
