 ...
 */
export class RgbImage extends Image<IntRawPixels, RgbaPixelColor> {
	/**
 ...
 */
export class RgbaImage extends Image<IntRawPixels, RgbaPixelColor> {
	/**
 ...
 */
export class YiqImage extends Image<FloatRawPixels, YiqPixelColor> {
	/**
