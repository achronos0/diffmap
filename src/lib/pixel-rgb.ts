 ...
 */
export function flatten (pixel: RgbaPixelColor, alphaRatio: number = 1): RgbaPixelColor {
	if (pixel.a === 255) {
		return pixel
	}
 ...
 */
export function greyscale (pixel: RgbaPixelColor, alphaRatio: number = 1): number {
...
export function blend (
	originalPixel: RgbaPixelColor,
	newPixel: RgbaPixelColor,
	mode: 'add' | 'average' | 'max' = 'average',
	channels: Array<'r' | 'g' | 'b'> = ['r', 'g', 'b']
): RgbaPixelColor {
	if (newPixel.a === 0) {
 ...
 */
export function yiq (pixel: RgbaPixelColor): YiqPixelColor {
 ...
 */
export function calcYiqY (pixel: RgbaPixelColor): number {
 ...
 */
export function calcYiqI (pixel: RgbaPixelColor): number {
 ...
 */
export function calcYiqQ (pixel: RgbaPixelColor): number {
