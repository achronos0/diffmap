 ...
 */
export function rgba (pixel: YiqPixelColor): RgbaPixelColor {
 ...
 */
export function calcRgbR (pixel: YiqPixelColor): number {
 ...
 */
export function calcRgbG (pixel: YiqPixelColor): number {
 ...
 */
export function calcRgbB (pixel: YiqPixelColor): number {
 ...
 */
export function colorDistance (fromPixel: YiqPixelColor, toPixel: YiqPixelColor): number {
 ...
 */
export function contrast (fromPixel: YiqPixelColor, toPixel: YiqPixelColor): number {
